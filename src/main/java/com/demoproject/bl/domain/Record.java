...
public class Record implements Serializable {
    ...
    public Record blRecordId(String blRecordId) {
    ...
    public Record typeOfResource(String typeOfResource) {
    ...
    public Record materialType(String materialType) {
    ...
    public Record bnbNumber(String bnbNumber) {
    ...
    public Record archivalResourceKey(String archivalResourceKey) {
    ...
    public Record datesAssociatedWithName(String datesAssociatedWithName) {
    ...
    public Record typeOfName(String typeOfName) {
    ...
    public Record allNames(String allNames) {
    ...
    public Record variantTitles(String variantTitles) {
    ...
    public Record seriesTitle(String seriesTitle) {
    ...
    public Record numberWithinSeries(String numberWithinSeries) {
    ...
    public Record countryOfPublication(String countryOfPublication) {
    ...
    public Record placeOfPublication(String placeOfPublication) {
    ...
    public Record dateOfPublication(String dateOfPublication) {
    ...
    public Record edition(String edition) {
    ...
    public Record physicalDescription(String physicalDescription) {
    ...
    public Record deweyClassification(String deweyClassification) {
    ...
    public Record blShelfmark(String blShelfmark) {
    ...
    public Record topics(String topics) {
    ...
    public Record genre(String genre) {
        this.setGenre(genre);
        return this;
    }
    ...
    public Record languages(String languages) {
    ...
    public Record provenance(String provenance) {
