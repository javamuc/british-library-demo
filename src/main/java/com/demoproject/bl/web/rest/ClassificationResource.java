...
import com.demoproject.bl.service.ClassificationService;
...
/**
 * REST controller for managing {@link com.demoproject.bl.domain.Classification}.
 */
@RestController
@RequestMapping("/api")
public class ClassificationResource {
    ...
    public ResponseEntity<ClassificationDTO> updateClassification(
        ...
        ClassificationDTO result = classificationService.update(classificationDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<ClassificationDTO>> getAllClassifications(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
